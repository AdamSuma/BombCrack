...
<link href="css/stil.css" rel="stylesheet">
  ...
  <div class="container-fluid">
   ...
   <!-- carousel-->	
  <div id="dan" class="carousel slide" data-ride="carousel" data-interval="3000" data-ride="carousel">
    	<!-- Carousel indicators -->
        <ol class="carousel-indicators">
            <li data-target="#dan" data-slide-to="0"></li>
            <li data-target="#dan" data-slide-to="1" class="active"></li>
            <li data-target="#dan" data-slide-to="2"></li>
		</ol>   
       <!-- Carousel items -->
        <div class="carousel-inner">
                <div class="item">
	                <img src="imagini/banner/learn.png" alt="primul" class="img-responsive"/>
                  
                </div>
                <div class="item active">
		            <img src="imagini/banner/fog.png" alt="doi" class="img-responsive"/>
                     
                </div>
                <div class="item">		  
				    <img src="imagini/banner/games_info.png" alt="trei" class="img-responsive"/>
              
                </div>
		</div>
        <!-- Carousel nav -->
            <a class="left carousel-control" href="#dan" data-slide="prev"><span class="icon-prev"></span></a>
			<a class="carousel-control right" href="#dan" data-slide="next"><span class="icon-next"></span></a>
 </div>
	<!-- carousel terminat-->
      ...
      <div class="media-body">
         ...
         <div class="media">
            <a class="pull-left" href="#">
               <img class="media-object" src="imagini/games1.jpg" width="100" height="100"
               alt="Generic placeholder image">
            </a>
            <div class="media-body">
               <h4 class="media-heading">Rpg games</h4>
...
<ul class="media-list">
      ...
      <div class="media-body">
         ...
         <div class="media">
            <a class="pull-left" href="#">
               <img class="media-object" src="imagini/games2.jpg" width="100" height="100"
               alt="Generic placeholder image">
            </a>
            <div class="media-body">
