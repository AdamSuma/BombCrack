...
$intrebare=mysql_query("SELECT * FROM comanda WHERE stare_comanda='anulata' order by id_comanda DESC");
...
$comenzi.='<tr><td colspan="4" align="center">Nu aveti comenzi anulate</td><td align="center">-</td></tr>';
