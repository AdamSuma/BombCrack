...
$mesaj.='<font size="2"><table border="1" cellspacing="0" cellpadding="4" width="600px">
			...
			<th colspan=5>Mesaje noi primite</th>
            </tr>
            <tr>
			<th>Data</th>
            <th>Primit de la</th>
...
$intrebare=mysql_query("SELECT * FROM tiket WHERE stare='necitit' order by id_tiket DESC ");
...
$mesaj.='<tr>
			...
			<td align="center"><a href="vezi_mesaj.php?id_mesaj='.$id_mesaj.'" onmouseover=this.style.color="#ff0000"; return true" onmouseout=this.style.color="#000000"; return true>Vizualizeaza</a></td>
		  	</tr>';

}
}else{
$mesaj.='<tr><td colspan="3" align="center">Nu aveti mesaje necitite</td><td align="center">-</td><td align="center">-</td></tr>';
