...
$randuri.='<tr><td>'.$cod_produs.'</td><td>'.$denumire_produs.'</td><td>buc</td><td>'.$pret_produs.'</td><td>'.$stoc_produs.'</td><td><a href="admin_facturi.php?fid_produs='.$cod_produs.'&actiune=adauga">Adauga</a></td></tr>';
...
<form method="post" action="admin_adauga_produse.php">
